/* Напишите программу с функцией для вычисления суммы нечётных натуральных чисел. */
...
int main() {
	...
	cout << "Задание:" << endl << "Напишите программу с функцией для вычисления суммы нечётных натуральных чисел." << endl << endl;
	//
